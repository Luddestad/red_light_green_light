...
class MovementOverlayWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: PosePainter(pose, imageSize, rotation, cameraLensDirection),
    );
  }
}

/// Official ML Kit sample painter: draws pose landmarks and connections with correct coordinate translation.
